...
public class VoiceCallActivity extends CallActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        swingCard = findViewById(R.id.swing_card);
        ...
        if (userMap != null && userMap.containsKey(username)) {
            String nickName = userMap.get(username).getNickname();
            Glide.with(this).load(userMap.get(username).getAvatar()).asBitmap().into(swingCard);
