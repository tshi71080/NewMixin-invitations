...
public class PickContactNoCheckboxActivity extends BaseActivity {
    ...
    private void getContactList() {
        ...
        for (Entry<String, EaseUser> entry : users.entrySet()) {
            if (!entry.getKey().equals(Constant.NEW_FRIENDS_USERNAME) && !entry.getKey().
                    equals(Constant.GROUP_USERNAME) && !entry.getKey().equals(Constant.CHAT_ROOM)
        ...
        if(null!=contactList&&contactList.size()>0){
            ...
            ToastUtils.showShortToast("暂时没有联系人，请先添加联系人");
        }
        // sort
