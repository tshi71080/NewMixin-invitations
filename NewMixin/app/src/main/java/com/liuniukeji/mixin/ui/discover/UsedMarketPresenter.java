...
public class UsedMarketPresenter implements UsedMarketContract.Presenter {
    UsedMarketContract.View mView;
    Context context;

    public UsedMarketPresenter(Context ctx) {
        this.context = ctx;
    }
    ...
    public void getMomentList(int p) {
        ...
        httpParams.put("p", p);
        OkGoRequest.post(UrlUtils.getSecondHandMarket, context,
    ...
    @Override
    public void attachView(@NonNull UsedMarketContract.View view) {
        mView = view;
    }
