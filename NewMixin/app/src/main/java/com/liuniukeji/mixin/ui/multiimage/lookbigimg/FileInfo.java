...
public class FileInfo implements Serializable {
    ...
    public FileInfo(int id, String url, String fileName, String schudleId , long length, long finish) {
        this.id = id;
        this.url = url;
        this.fileName = fileName;
        this.schudleId = schudleId;
        this.length = length;
        this.finish = finish;
    }
    ...
    public void setSchudleId(String schudleId) {
        this.schudleId = schudleId;
    }
