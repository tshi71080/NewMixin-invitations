...
public class ImageDisplayer {
    ...
    public Bitmap compressImg(String path, boolean showThumb)
        ...
        if (showThumb) {
//			int be = 0;
//			if (opt.outWidth > opt.outHeight && opt.outWidth > THUMB_WIDTH){
//				be = (int)(opt.outWidth / THUMB_WIDTH);
//			}else if (opt.outWidth < opt.outHeight && opt.outHeight > THUMB_HEIGHT){
//				be = (int)(opt.outHeight / THUMB_HEIGHT);
//			}
//			if (be <= 0)
//				be = 1;
//			opt.inSampleSize = be;
