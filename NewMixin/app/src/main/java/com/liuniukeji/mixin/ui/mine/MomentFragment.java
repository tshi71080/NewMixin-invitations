...
public class MomentFragment extends BaseFragment implements MomentContract.View {
    ...
    MomentContract.Presenter presenter;
    ...
    public View getLayout(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.fragment_moment, null, false);
        return view;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        presenter = new MomentPresenter(getContext());
    ...
    private void getData() {
        if (EmptyUtils.isNotEmpty(memberId)) {
            presenter.getSomeoneMomentList(p, memberId);
        } else {
            ToastUtils.showShortToast("页面参数错误，无法获取动态列表数据");
        }
    }
    ...
    class MomentAdapter2 extends BaseQuickAdapter<MomentInfo, BaseViewHolder> {

        public MomentAdapter2(@Nullable List<MomentInfo> data) {
            super(R.layout.moment_mine_item, data);
        }
        ...
        protected void convert(BaseViewHolder helper, final MomentInfo item) {
            ...
            String id = AccountUtils.getUser(getActivity()).getId();
            ...
            deleteIv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (EmptyUtils.isNotEmpty(item.getId())) {
                        AlertDialog dialog = new AlertDialog.Builder(getActivity()).setTitle("提示").setMessage("确定要删除本条动态吗？").
                                setPositiveButton("确定", new DialogInterface.OnClickListener() {
                                    @Override
                                    public void onClick(DialogInterface arg0, int arg1) {
                                        //调用删除接口
                                        presenter.delMoment(item.getId());
                                    }
                        ...
                        ToastUtils.showShortToast("缺少必要参数，无法删除本条动态");
                    }
                }
            });
