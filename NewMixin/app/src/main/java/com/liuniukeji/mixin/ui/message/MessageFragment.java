 ...
 * 消息页面
 */
public class MessageFragment extends MyConversationListFragment {
                ...
                if (username.equals(EMClient.getInstance().getCurrentUser())) {
                    ...
                    try {
                        if(conversation.getLatestMessageFromOthers()!=null){
                            intent.putExtra("tochatusername",conversation.getLatestMessageFromOthers().getStringAttribute("real_name"));
                        }
