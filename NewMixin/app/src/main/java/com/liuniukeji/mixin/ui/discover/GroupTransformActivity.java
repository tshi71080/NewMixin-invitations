 ...
 * 群组转让
 */
public class GroupTransformActivity extends AppCompatActivity implements
        GroupTransformContract.View {
    ...
    GroupTransformContract.Presenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headTitleTv.setText("群组转让");
        presenter = new GroupTransformPresenter(this);
        ...
        //获取列表数据
        presenter.getGroupMemberList(p,groupImId);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                intent.setClass(GroupTransformActivity.this, FriendProfileActivity.class);
    ...
    public void liftData(CommonResult result) {
        ...
        if (result.getStatus() == 1) {
            //转让成功，结束页面返回
            EventBus.getDefault().post(Constants.GROUP_INFO.ON_CHANGE);
            finish();
        }
    }
    ...
    class AttentionAdapter extends BaseQuickAdapter<GroupMembers, BaseViewHolder> {

        public AttentionAdapter(@Nullable List<GroupMembers> data) {
            super(R.layout.invite_friend_item, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, final GroupMembers item) {
            ...
            inviteTv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    transformConfirm(item.getMember_id());
                }
            });
     ...
     * @param memberId
     */
    private void transformConfirm(final String memberId) {
        AlertDialog.Builder builder = new AlertDialog.Builder(GroupTransformActivity.this);
        builder.setTitle("提示");
        builder.setMessage("确定要将群组转让给该好友吗");
        builder.setPositiveButton("确定", new DialogInterface.OnClickListener() {

            @Override
            public void onClick(DialogInterface dialog, int which) {
                //群转让操作
                presenter.changeGroupOwner(groupImId, memberId);
            }
        });
