 ...
 * 我的关注
 */
public class AttentionActivity extends AppCompatActivity implements AttentionContract.View {
    ...
    AttentionContract.Presenter presenter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        headTitleTv.setText("我的关注");
        presenter = new AttentionPresenter(this);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                intent.setClass(AttentionActivity.this, FriendProfileActivity.class);
    ...
    class AttentionAdapter extends BaseQuickAdapter<AttentionInfo, BaseViewHolder> {
        ...
        public AttentionAdapter(@Nullable List<AttentionInfo> data) {
            //super(R.layout.attention_list_item, data);
            super(R.layout.visitor_list_item, data);
        }

        @Override
        protected void convert(BaseViewHolder helper, AttentionInfo item) {
