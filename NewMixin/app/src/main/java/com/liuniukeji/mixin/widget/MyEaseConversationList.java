...
import com.liuniukeji.mixin.ui.message.MyEaseConversationAdapter;
...
public class MyEaseConversationList extends ListView{
    ...
    public void init(List<EMConversation> conversationList, EaseConversationListHelper helper){
        ...
        adapter = new MyEaseConversationAdapter(context, 0, conversationList);
        adapter.setCvsListHelper((EaseConversationList.EaseConversationListHelper) conversationListHelper);
