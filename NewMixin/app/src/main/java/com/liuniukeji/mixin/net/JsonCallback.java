...
import com.liuniukeji.mixin.util.PreferenceUtils;
import com.liuniukeji.mixin.util.PreferencesUtils;
...
public abstract class JsonCallback<T> extends AbsCallback<T> {
    ...
    public JsonCallback(Context context, PtrLayout ptrView, View errorView) {
        this.context = context;
