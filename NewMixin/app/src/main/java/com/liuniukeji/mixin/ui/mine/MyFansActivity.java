...
public class MyFansActivity extends AppCompatActivity implements MyFansContract.View {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new FansAdapter(dataList);
        ...
        mAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                intent.setClass(MyFansActivity.this, FriendProfileActivity.class);
    ...
    @Override
    public void liftData(List<FansInfo> infoList) {
    ...
    class FansAdapter extends BaseQuickAdapter<FansInfo, BaseViewHolder> {
