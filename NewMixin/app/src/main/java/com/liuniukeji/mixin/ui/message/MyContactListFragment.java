...
public class MyContactListFragment extends BaseFragment implements ContactListContract.View{
    ...
    public static MyContactListFragment newInstance(String param1, String param2) {
    ...
    public View getLayout(LayoutInflater inflater) {
        View view = inflater.inflate(R.layout.fragment_my_contact_list, null);
            ...
            if (null != groupInfoList && groupInfoList.size() > 0 && groupInfoList.get(groupPosition).getFollow_list() != null) {
                ...
                allLy.setOnLongClickListener(new View.OnLongClickListener() {
                    ...
                    public boolean onLongClick(View v) {
                        ...
                        intent.setClass(getActivity(), FriendEditDialog.class);
                        startActivity(intent);
                        return true;
                    }
                });
