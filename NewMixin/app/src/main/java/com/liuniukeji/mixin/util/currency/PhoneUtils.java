...
public class PhoneUtils {
    ...
    public static String getIMEI() {
        TelephonyManager tm = (TelephonyManager) Utils.getContext().getSystemService(Context.TELEPHONY_SERVICE);
        if (ActivityCompat.checkSelfPermission(Utils.getContext(), Manifest.permission.READ_PHONE_STATE)
                != PackageManager.PERMISSION_GRANTED) {
            // TODO: Consider calling
            String[] permissions = {Manifest.permission.READ_PHONE_STATE};
//            ActivityCompat.requestPermissions(Utils.getContext(), permissions, 0);
        }
...
//            String regExp = "^((13[0-9])|(15[^4])|(18[0,2,3,5-9])|(17[0-8])|(147))\\d{8}$";
                Pattern pattern = Pattern.compile("((13[0-9])|(14[5|7])|(15([0-3]|[5-9]))|(17([0|1|3]|[5-8]))" +
                        "|(166)|(18[0-9])|(19[8|9]))\\d{8}");
