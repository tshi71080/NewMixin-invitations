...
public class MomentNearPresenter implements MomentNearContract.Presenter {
    MomentNearContract.View mView;
    Context context;

    public MomentNearPresenter(Context ctx) {
        this.context = ctx;
    }


    @Override
    public void getMomentList(int p,String lng,String lat) {
        HttpParams httpParams = new HttpParams();
        httpParams.put("token", AccountUtils.getUserToken(context));
        httpParams.put("p", p);
        httpParams.put("lng", lng);
        httpParams.put("lat", lat);
        OkGoRequest.post(UrlUtils.getNearbyMoment, context,
    ...
    @Override
    public void attachView(@NonNull MomentNearContract.View view) {
        mView = view;
    }
