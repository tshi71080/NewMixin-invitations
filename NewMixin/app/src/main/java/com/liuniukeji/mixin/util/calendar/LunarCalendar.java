package com.liuniukeji.mixin.util.calendar;
...
public class LunarCalendar {
    ...
    // 农历部分假日
    final static String[] lunarHoliday = new String[]{"0101 春节", "0115 元宵节", "0505 端午节", "0707 七夕节",
            "0715 中元节", "0722 财神节", "0815 中秋节", "0909 重阳节", "1208 腊八节", "1224 小年", "0100 除夕"};
     ...
     * <p>
     * isday: 这个参数为false日期为节假日时，阴历日期就返回节假日，
     * true不管日期是否为节假日依然返回这天对应的阴历日期
     */
